...
ActiveRecord::Schema[7.1].define(version: 20_240_418_200_906) do
  ...
  create_table 'calendar_horses_participant_reservations', id: false, force: :cascade do |t|
    ...
    t.index %w[calendar_horse_id participant_reservation_id],
            name: 'idx_on_calendar_horse_id_participant_reservation_id_a1985287be'
    t.index %w[participant_reservation_id calendar_horse_id],
            name: 'idx_on_participant_reservation_id_calendar_horse_id_00bf37d185'
  end
  ...
  create_table 'calendar_ponies_participant_reservations', id: false, force: :cascade do |t|
    ...
    t.index %w[calendar_pony_id participant_reservation_id],
            name: 'idx_on_calendar_pony_id_participant_reservation_id_96526e65f9'
    t.index %w[participant_reservation_id calendar_pony_id],
            name: 'idx_on_participant_reservation_id_calendar_pony_id_a445630158'
  end
